...
[Play Foldspace](https://foldspace-by-cruz.cg-stackd.chatgpt.site/) · [Explore the source](./foldspace) · [Download the 30-second Instagram demo](./foldspace/media/Foldspace-Instagram.mp4) · [What was verified](./foldspace/docs/VERIFICATION.md)

Play in your browser with keyboard or touch controls. No account or API key is required.
...
<table>
  ...
  <tr>
    <td colspan="2">
      <a href="./memory-city">
        <img src="./docs/assets/showcase/memory-city.webp" alt="Miniature city with glowing paths connecting ideas, themes, and open questions.">
      </a>
      <br>
  ...
  <tr>
    <td width="50%">
      <a href="./explain-it-visually">
        <img src="./docs/assets/showcase/explain-it-visually.webp" alt="Miniature explanation machine turning a tangled idea into clear visual panels.">
      </a>
      <br>
    ...
    <td width="50%">
      <a href="./ai-workflow-lab">
        <img src="./docs/assets/showcase/ai-workflow-lab.webp" alt="Miniature workshop moving rough notes and ideas through validation into useful outputs.">
      </a>
      <br>
  ...
  <tr>
    <td width="50%">
      <a href="./no-megaphone">
        <img src="./docs/assets/showcase/no-megaphone.webp" alt="Miniature decision room moving a draft from noise toward a useful conversation.">
      </a>
      <br>
    ...
    <td width="50%">
      <a href="./chatgpt-ads">
        <img src="./docs/assets/showcase/chatgpt-ads.webp" alt="Miniature campaign desk sorting exported data through transparent review rules.">
      </a>
      <br>
