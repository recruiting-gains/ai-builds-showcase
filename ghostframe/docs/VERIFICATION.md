...
The [phone tracking repair](PHONE-TRACKING-STABILITY.md) passes 242 application tests, 14 harness tests, the existing 31 phone checks and 14 new stability checks in each of Chromium and WebKit. Actual MediaPipe worker processing also passes with generated portrait and landscape input. Types, production build, model integrity, dependency audit and deployment dry run pass.
