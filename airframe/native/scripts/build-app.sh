...
/usr/bin/ditto "$native_dir/docs/RELEASE-0.1.3.md" "$stage_app/Contents/Resources/docs/RELEASE-0.1.3.md"
/usr/bin/ditto "$native_dir/docs/RELEASE-0.1.4.md" "$stage_app/Contents/Resources/docs/RELEASE-0.1.4.md"
