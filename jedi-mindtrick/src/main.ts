...
<main>
  ...
  <section class="playground" aria-label="Camera playground">
    ...
    <aside class="controls" aria-label="Effect controls">
      ...
      <div id="camera-dock"><div class="camera-actions"><button class="primary" id="start-camera">Start your camera <span>↗</span></button><button id="stop-camera" class="secondary" hidden>Stop camera</button></div></div>
      ...
      <div id="handframe-controls" hidden>
        <section class="world-controls" aria-label="Choose your world"><div class="section-label"><span>01 / CHOOSE YOUR WORLD</span><span>LOCAL FILTER</span></div>
        ...
        <section class="still-controls" aria-label="Optional AI still"><div class="section-label"><span>04 / MAKE AN AI STILL</span><span>OPTIONAL UPLOAD</span></div>
...
function syncGestureHelp(){$('#gesture-help').textContent=mode==='invisible'?'Open palm: visible. Slowly close your hand to disappear. Open it again to return.':handFollowing?'Form an opening with both L-shaped hands—even with one upside down. Open to design. Bring both hands together, then reopen for the next world.':'Push one hand forward, pull the other back. Lift to tilt. Quick pinch: style. Hold 0.6s: prepare a still.';}
